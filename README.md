...
3. Set up prometheus (relevant files in prometheus/):
   - Follow instructions from [here](https://devopscube.com/setup-prometheus-monitoring-on-kubernetes/) (skip creating 'monitoring' namespace since already done in step 1)
